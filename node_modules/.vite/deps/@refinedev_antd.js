...
import {
  ...
  yr,
  yv
} from "./chunk-D2S7BSRB.js";
import "./chunk-RZO2CY75.js";
import "./chunk-T4K5N7DV.js";
import {
  require_react_dom
...
var require_markdown_table = __commonJS({
  "node_modules/markdown-table/index.js"(exports, module) {
    ...
    function toAlignment(value) {
      ...
      return code === L || code === l ? l : code === R2 || code === r ? r : code === C || code === c ? c : x;
    }
  }
});
...
var he = o2(({ action: e2, resource: t, onMutationSuccess: r, onMutationError: s, autoSave: n2, submitOnEnter: i = false, warnWhenUnsavedChanges: a, redirect: l, successNotification: u, errorNotification: y, meta: p, metaData: f, queryMeta: d, mutationMeta: T, liveMode: g, liveParams: m, mutationMode: b, dataProviderName: x, onLiveEvent: C, invalidates: S2, undoableTimeout: P, queryOptions: F, createMutationOptions: B, updateMutationOptions: v, id: D, overtimeOptions: c, optimisticUpdateMap: k, defaultFormValues: U, disableServerSideValidation: H = false } = {}) => {
  var te2, ne2;
  let { options: G2 } = ne(), h = (G2 == null ? void 0 : G2.disableServerSideValidation) || H, q = G(), [Y2] = form_default.useForm(), A = useForm({ form: Y2, defaultFormValues: U }), { form: E } = A, $ = _P({ onMutationSuccess: r || void 0, onMutationError: async (j, ae2, ce2) => {
    if (h) {
      s == null || s(j, ae2, ce2);
      return;
    }
    let X = [], oe = E.getFieldsValue();
    X = Object.keys(ur(oe)).map((fe) => ({ name: Jo(fe), errors: void 0 })), E.setFields(X);
    let ye = j == null ? void 0 : j.errors;
    for (let fe in ye) {
      let pe = ye[fe], Qe = [];
      Array.isArray(pe) && (Qe = pe), typeof pe == "string" && (Qe = [pe]), typeof pe == "boolean" && pe && (Qe = ["Field is not valid."]), typeof pe == "object" && "key" in pe && (Qe = [q(pe.key, pe.message)]), X.push({ name: Jo(fe), errors: Qe });
    }
    E.setFields([...X]), s == null || s(j, ae2, ce2);
  }, redirect: l, action: e2, resource: t, successNotification: u, errorNotification: y, meta: S(p, f), metaData: S(p, f), queryMeta: d, mutationMeta: T, liveMode: g, liveParams: m, mutationMode: b, dataProviderName: x, onLiveEvent: C, invalidates: S2, undoableTimeout: P, queryOptions: F, createMutationOptions: B, updateMutationOptions: v, id: D, overtimeOptions: c, optimisticUpdateMap: k, autoSave: n2 }), { formLoading: L, onFinish: M, queryResult: V, id: Z2, onFinishAutoSave: Q } = $, { warnWhenUnsavedChanges: O2, setWarnWhen: w } = lt(), z = a ?? O2;
  import_react74.default.useEffect(() => {
    E.resetFields();
  }, [(te2 = V == null ? void 0 : V.data) == null ? void 0 : te2.data, Z2]);
  let _ = o2((j) => {
    i && j.key === "Enter" && E.submit();
  }, "onKeyUp"), ee = o2((j, ae2) => {
    if (j && z && w(true), n2 != null && n2.enabled) {
      w(false);
      let ce2 = (n2 == null ? void 0 : n2.onFinish) ?? ((X) => X);
      return Q(ce2(ae2)).catch((X) => X);
    }
    return j;
  }, "onValuesChange"), J = { disabled: L, onClick: () => {
    E.submit();
  } };
  return { form: A.form, formProps: { ...A.formProps, onFinish: (j) => M(j).catch((ae2) => ae2), onKeyUp: _, onValuesChange: ee, initialValues: (ne2 = V == null ? void 0 : V.data) == null ? void 0 : ne2.data }, saveButtonProps: J, defaultFormValuesLoading: A.defaultFormValuesLoading, ...$, onFinish: async (j) => await M(j ?? A.form.getFieldsValue(true)) };
}, "useForm");
var to = o2(({ modalProps: e2 = {} } = {}) => {
  let { show: t, close: r, visible: s } = WR({ defaultVisible: e2.open });
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  var O2, w;
  let [l, u] = import_react75.default.useState(false), y = be(), { resource: p, action: f, identifier: d } = O(a.resource), T = ae(), g = ge(), m = at(), b = a.action ?? f ?? "", x = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), C = typeof e2 == "object" && "key" in e2 ? e2.key : p && b && e2 ? `modal-${d}-${b}` : void 0, S2 = he({ meta: { ...C ? { [C]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: P, formProps: F, id: B, setId: v, formLoading: D, onFinish: c, autoSaveProps: k } = S2, U = G(), { warnWhen: H, setWarnWhen: G2 } = lt(), { show: h, close: q, modalProps: Y2 } = to({ modalProps: { open: t } }), A = Y2.open || false, E = { modalProps: Y2, form: P, formLoading: D, formProps: F, formResult: void 0, formValues: P.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: c, close: q, open: Y2.open || false, show: h, visible: A };
  import_react75.default.useEffect(() => {
    var z, _, ee, J;
    if (l === false && C) {
      let te2 = (_ = (z = T == null ? void 0 : T.params) == null ? void 0 : z[C]) == null ? void 0 : _.open;
      if (typeof te2 == "boolean" ? te2 && h() : typeof te2 == "string" && te2 === "true" && h(), x) {
        let ne2 = (J = (ee = T == null ? void 0 : T.params) == null ? void 0 : ee[C]) == null ? void 0 : J.id;
        ne2 && (v == null || v(ne2));
      }
      u(true);
    }
  }, [C, T, x, v]), import_react75.default.useEffect(() => {
    var z;
    l === true && (A && C ? g({ query: { [C]: { ...(z = T == null ? void 0 : T.params) == null ? void 0 : z[C], open: true, ...x && B && { id: B } } }, options: { keepQuery: true }, type: "replace" }) : C && !A && g({ query: { [C]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [B, A, h, C, x]);
  let $ = { disabled: D, loading: D, onClick: () => {
    P.submit();
  } }, L = (0, import_react75.useCallback)(() => {
    if (k.status === "success" && (n2 != null && n2.invalidateOnClose) && y({ id: B, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: d }), H) if (window.confirm(U("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) G2(false);
    else return;
    v == null || v(void 0), E.close();
  }, [H, k.status]), M = (0, import_react75.useCallback)((z) => {
    typeof z < "u" && (v == null || v(z)), (!(b === "edit" || b === "clone") || (typeof z < "u" || typeof B < "u")) && E.show();
  }, [B]), { visible: V, ...Z2 } = Y2, Q = { open: V, ...Z2 };
  return { ...S2, ...E, show: M, close: L, open: A, formProps: { ...F, ...S2.formProps, onValuesChange: F == null ? void 0 : F.onValuesChange, onKeyUp: F == null ? void 0 : F.onKeyUp, onFinish: async (z) => {
    await c(z), r && q(), s && P.resetFields();
  } }, modalProps: { ...Q, width: "1000px", okButtonProps: $, title: U(`${d}.titles.${a.action}`, `${m(`${a.action} ${((O2 = p == null ? void 0 : p.meta) == null ? void 0 : O2.label) ?? ((w = p == null ? void 0 : p.options) == null ? void 0 : w.label) ?? (p == null ? void 0 : p.label) ?? d}`, "singular")}`), okText: U("buttons.save", "Save"), cancelText: U("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: D };
}, "useModalForm");
var no = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  let l = be(), [u, y] = import_react76.default.useState(false), { visible: p, show: f, close: d } = WR({ defaultVisible: t }), { resource: T, action: g, identifier: m } = O(a.resource), b = ae(), x = ge(), C = a.action ?? g ?? "", S2 = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), P = typeof e2 == "object" && "key" in e2 ? e2.key : T && C && e2 ? `drawer-${(T == null ? void 0 : T.identifier) ?? (T == null ? void 0 : T.name)}-${C}` : void 0, F = he({ meta: { ...P ? { [P]: void 0 } : {}, ...a.meta }, autoSave: n2, invalidates: i, ...a }), { form: B, formProps: v, formLoading: D, id: c, setId: k, onFinish: U, autoSaveProps: H } = F;
  import_react76.default.useEffect(() => {
    var L, M, V, Z2;
    if (u === false && P) {
      let Q = (M = (L = b == null ? void 0 : b.params) == null ? void 0 : L[P]) == null ? void 0 : M.open;
      if (typeof Q == "boolean" ? Q ? f() : d() : typeof Q == "string" && Q === "true" && f(), S2) {
        let O2 = (Z2 = (V = b == null ? void 0 : b.params) == null ? void 0 : V[P]) == null ? void 0 : Z2.id;
        O2 && (k == null || k(O2));
      }
      y(true);
    }
  }, [P, b, S2, k, u]), import_react76.default.useEffect(() => {
    var L;
    u === true && (p && P ? x({ query: { [P]: { ...(L = b == null ? void 0 : b.params) == null ? void 0 : L[P], open: true, ...S2 && c && { id: c } } }, options: { keepQuery: true }, type: "replace" }) : P && !p && x({ query: { [P]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [c, p, f, d, P, S2, u]);
  let G2 = G(), { warnWhen: h, setWarnWhen: q } = lt(), Y2 = { disabled: D, onClick: () => {
    B.submit();
  }, loading: D }, A = { recordItemId: c, onSuccess: () => {
    k == null || k(void 0), d();
  } }, E = (0, import_react76.useCallback)(() => {
    if (H.status === "success" && (n2 != null && n2.invalidateOnClose) && l({ id: c, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), h) if (window.confirm(G2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) q(false);
    else return;
    d(), k == null || k(void 0);
  }, [h]), $ = (0, import_react76.useCallback)((L) => {
    typeof L < "u" && (k == null || k(L)), (!(C === "edit" || C === "clone") || (typeof L < "u" || typeof c < "u")) && f();
  }, [c]);
  return { ...F, show: $, close: E, formProps: { form: B, ...F.formProps, onValuesChange: v == null ? void 0 : v.onValuesChange, onKeyUp: v == null ? void 0 : v.onKeyUp, onFinish: async (L) => {
    await U(L), r && d(), s && B.resetFields();
  } }, drawerProps: { width: "500px", onClose: E, open: p, forceRender: true }, saveButtonProps: Y2, deleteButtonProps: A, formLoading: D };
}, "useDrawerForm");
var ao = o2((e2 = {}) => {
  let t = he({ ...e2 }), { form: r, formProps: s } = t, n2 = useStepsForm({ isBackValidate: false, form: r, submit: (i) => {
    var a;
...
var Er = o2((e2, t, r = "eq") => ia(e2, t, r), "getDefaultFilter");
var yt = o2((e2) => {
  let t = [];
...
var Ce = o2(({ to: e2, element: t }) => {
  let { Link: r } = te(), s = Z(), n2 = ot();
  return import_react78.default.createElement(s === "legacy" ? r : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, t);
}, "PaginationLink");
var gt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: f, syncWithLocation: d, resource: T, successNotification: g, errorNotification: m, queryOptions: b, liveMode: x, onLiveEvent: C, liveParams: S2, meta: P, metaData: F, dataProviderName: B } = {}) => {
  let { tableQueryResult: v, current: D, setCurrent: c, pageSize: k, setPageSize: U, filters: H, setFilters: G2, sorters: h, setSorters: q, sorter: Y2, setSorter: A, createLinkForSyncWithLocation: E, pageCount: $, overtime: L } = qh({ permanentSorter: a, permanentFilter: u, initialCurrent: t, initialPageSize: r, pagination: n2, hasPagination: s, filters: p, sorters: f, initialSorter: i, initialFilter: l, syncWithLocation: d, resource: T, defaultSetFilterBehavior: y, successNotification: g, errorNotification: m, queryOptions: b, liveMode: x, onLiveEvent: C, liveParams: S2, meta: S(P, F), metaData: S(P, F), dataProviderName: B }), { syncWithLocation: M } = Kr(), V = d ?? M, Z2 = grid_default.useBreakpoint(), [Q] = form_default.useForm(), O2 = useForm({ form: Q }), w = Bs(x), z = s === false ? "off" : "server", _ = ((n2 == null ? void 0 : n2.mode) ?? z) !== "off", ee = S(p == null ? void 0 : p.initial, l), { data: J, isFetched: te2, isLoading: ne2 } = v;
  import_react77.default.useEffect(() => {
    if (V) {
      let X = O2.form.getFieldsValue(), oe = Object.keys(X).reduce((de, ye) => {
        let fe = H.find((pe) => "field" in pe && pe.field === ye);
        return fe && (de[ye] = fe == null ? void 0 : fe.value), de;
      }, {});
      O2.form.setFieldsValue(oe);
    }
  }, [V]);
  let j = o2((X, oe, de) => {
    ...
    _ && (c == null || c(X.current || 1), U == null || U(X.pageSize || 10));
  }, "onChange"), ae2 = o2(async (X) => {
    if (e2) {
      let oe = await e2(X);
      G2(oe), _ && (c == null || c(1));
    }
  }, "onFinish"), ce2 = o2(() => _ ? { itemRender: (X, oe, de) => {
    var fe;
    let ye = E({ pagination: { pageSize: k, current: X }, sorters: h, filters: H });
    if (oe === "page") return (0, import_react77.createElement)(Ce, { to: ye, element: `${X}` });
    if (oe === "next" || oe === "prev") return (0, import_react77.createElement)(Ce, { to: ye, element: de });
    if (oe === "jump-next" || oe === "jump-prev") {
      let pe = (fe = de == null ? void 0 : de.props) == null ? void 0 : fe.children;
      return (0, import_react77.createElement)(Ce, { to: ye, element: import_react77.Children.count(pe) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, pe) : pe });
    }
    return de;
  }, pageSize: k, current: D, simple: !Z2.sm, position: Z2.sm ? ["bottomRight"] : ["bottomCenter"], total: J == null ? void 0 : J.total } : false, "antdPagination");
  return { searchFormProps: { ...O2.formProps, onFinish: ae2 }, tableProps: { dataSource: J == null ? void 0 : J.data, loading: w === "auto" ? ne2 : !te2, onChange: j, pagination: ce2(), scroll: { x: true } }, tableQueryResult: v, sorters: h, sorter: Y2, filters: H, setSorters: q, setSorter: A, setFilters: G2, current: D, setCurrent: c, pageSize: k, setPageSize: U, pageCount: $, createLinkForSyncWithLocation: E, overtime: L };
}, "useTable");
var Gr = o2(({ autoSubmitClose: e2 = true, ...t } = {}) => {
  let r = gt({ ...t, successNotification: void 0, errorNotification: void 0 }), s = he({ ...t, action: "edit", redirect: false }), { id: n2, setId: i, saveButtonProps: a } = s, l = { onClick: () => {
    i(void 0);
...
var pm = o2((e2) => {
  let { queryResult: t, defaultValueQueryResult: r, onSearch: s, options: n2 } = Gh(e2);
  return { selectProps: { options: n2, onSearch: s, loading: r.isFetching, showSearch: true, filterOption: false }, queryResult: t, defaultValueQueryResult: r };
}, "useSelect");
var mm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, selectedOptionsOrder: f, onLiveEvent: d, liveParams: T, meta: g, metaData: m, dataProviderName: b }) => {
  let { queryResult: x, options: C } = Gh({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, selectedOptionsOrder: f, onLiveEvent: d, liveParams: T, meta: S(g, m), metaData: S(g, m), dataProviderName: b });
  return { checkboxGroupProps: { options: C, defaultValue: p }, queryResult: x };
}, "useCheckboxGroup");
var Tm = o2(({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, selectedOptionsOrder: f, onLiveEvent: d, liveParams: T, meta: g, metaData: m, dataProviderName: b }) => {
  let { queryResult: x, options: C } = Gh({ resource: e2, sort: t, sorters: r, filters: s, optionLabel: n2, optionValue: i, queryOptions: a, fetchSize: l, pagination: u, liveMode: y, defaultValue: p, selectedOptionsOrder: f, onLiveEvent: d, liveParams: T, meta: S(g, m), metaData: S(g, m), dataProviderName: b });
  return { radioGroupProps: { options: C, defaultValue: p }, queryResult: x };
}, "useRadioGroup");
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((p) => p, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: l, dataProviderName: u, onProgress: y } = {}) => {
  let p = G(), { resource: f } = O(e2 ?? t), { mutationResult: d, isLoading: T, handleChange: g } = NR({ resource: (f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name), mapData: r, paparseOptions: s, batchSize: n2, meta: S(a, l), metaData: S(a, l), dataProviderName: u, onFinish: i, onProgress: y ?? (({ totalAmount: m, processedAmount: b }) => {
    if (m > 0 && b > 0) {
  ...
  return { uploadProps: { onChange: g, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: T }, mutationResult: d, isLoading: T };
}, "useImport");
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: f, onSearch: d, queryOptions: T, syncWithLocation: g, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: S2, meta: P, metaData: F, dataProviderName: B } = {}) => {
  let { sorters: v, sorter: D, filters: c, current: k, pageSize: U, pageCount: H, setFilters: G2, setCurrent: h, setPageSize: q, setSorter: Y2, setSorters: A, createLinkForSyncWithLocation: E, tableQueryResult: $, overtime: L } = qh({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, filters: p, sorters: f, defaultSetFilterBehavior: y, initialCurrent: t, initialPageSize: r, queryOptions: T, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: S2, meta: S(P, F), metaData: S(P, F), syncWithLocation: g, dataProviderName: B, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", V = ((s == null ? void 0 : s.mode) ?? M) !== "off", Z2 = grid_default.useBreakpoint(), Q = Bs(x), [O2] = form_default.useForm(), { data: w, isFetched: z, isLoading: _ } = $, ee = o2((ne2, j) => {
    V && (h(ne2), q(j || 10));
  }, "onChange"), J = o2(async (ne2) => {
    if (d) {
      let j = await d(ne2);
      return V && (h == null || h(1)), G2(j);
    }
  }, "onFinish"), te2 = o2(() => V ? { itemRender: (ne2, j, ae2) => {
    var X;
    let ce2 = E({ pagination: { pageSize: U, current: ne2 }, sorters: v, filters: c });
    if (j === "page") return (0, import_react80.createElement)(Ce, { to: ce2, element: `${ne2}` });
    if (j === "next" || j === "prev") return (0, import_react80.createElement)(Ce, { to: ce2, element: ae2 });
    if (j === "jump-next" || j === "jump-prev") {
      let oe = (X = ae2 == null ? void 0 : ae2.props) == null ? void 0 : X.children;
      return (0, import_react80.createElement)(Ce, { to: ce2, element: import_react80.Children.count(oe) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, oe) : oe });
    }
    return ae2;
  }, pageSize: U, current: k, simple: !Z2.sm, total: w == null ? void 0 : w.total, onChange: ee } : false, "antdPagination");
  return { searchFormProps: { form: O2, onFinish: J }, listProps: { dataSource: w == null ? void 0 : w.data, loading: Q === "auto" ? _ : !z, pagination: te2() }, queryResult: $, filters: c, setFilters: G2, sorter: D, setSorter: Y2, sorters: v, setSorters: A, current: k, setCurrent: h, pageSize: U, setPageSize: q, pageCount: H, createLinkForSyncWithLocation: E, overtime: L };
}, "useSimpleList");
var Am = o2(() => {
...
var Ae = import_react83.default.createContext({ siderCollapsed: false, mobileSiderOpen: false, setSiderCollapsed: () => {
}, setMobileSiderOpen: () => {
} });
var ht = o2(({ children: e2, initialSiderCollapsed: t }) => {
  ...
  return import_react83.default.createElement(Ae.Provider, { value: { siderCollapsed: r, mobileSiderOpen: n2, setSiderCollapsed: s, setMobileSiderOpen: i } }, e2);
}, "ThemedLayoutContextProvider");
var Gm = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s } = (0, import_react82.useContext)(Ae);
  return { siderVisible: e2, setSiderVisible: r, drawerSiderVisible: t, setDrawerSiderVisible: s };
}, "useSiderVisible");
var fo = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s } = (0, import_react84.useContext)(Ae);
...
var ac2 = { open: ({ key: e2, message: t, description: r, type: s, cancelMutation: n2, undoableTimeout: i }) => {
...
var Ct2 = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react88.useState)(false), [i, a] = (0, import_react88.useState)(false), l = qr(), u = Z(), y = ot(), { warnWhen: p, setWarnWhen: f } = lt(), { Link: d } = te(), T = u === "legacy" ? d : y, g = ea(), m = G(), { menuItems: b, selectedKey: x, defaultOpenKeys: C } = vu({ meta: r }), S2 = grid_default.useBreakpoint(), { hasDashboard: P } = ne(), F = Y(), { mutate: B } = yr({ v3LegacyAuthProviderCompatible: !!(F != null && F.isLegacy) }), v = typeof S2.lg > "u" ? false : !S2.lg, D = e2 ?? g ?? Ft, c = o2((E, $) => E.map((L) => {
    let { icon: M, label: V, route: Z2, key: Q, name: O2, children: w, parentName: z, meta: _, options: ee } = L;
    if (w.length > 0) return import_react88.default.createElement(ac, { key: L.key, resource: O2, action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.SubMenu, { key: L.key, icon: M ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: V }, c(w, $)));
    let J = Q === $, te2 = !(S(_ == null ? void 0 : _.parent, ee == null ? void 0 : ee.parent, z) !== void 0 && w.length === 0);
    return import_react88.default.createElement(ac, { key: L.key, resource: O2, action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: J ? "bold" : "normal" }, icon: M ?? (te2 && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(T, { to: Z2 ?? "" }, V), !s && J && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), k = o2(() => {
    p ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (f(false), B()) : B();
  }, "handleLogout"), U = l && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: k, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), H = P ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: x === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(T, { to: "/" }, m("dashboard.title", "Dashboard")), !s && x === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, G2 = c(b, x), h = o2(() => t ? t({ dashboard: H, items: G2, logout: U, collapsed: s }) : import_react88.default.createElement(import_react88.default.Fragment, null, H, G2, U), "renderSider"), q = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: x ? [x] : [], defaultOpenKeys: C, mode: "inline", onClick: () => {
    a(false), S2.lg || n2(true);
  } }, h())), "renderMenu"), Y2 = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(D, { collapsed: false }), q()))), import_react88.default.createElement(button_default, { style: To, size: "large", onClick: () => a(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => v ? Y2() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (E) => n2(E), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(D, { collapsed: s }), q()), "renderContent")());
}, "Sider");
var Bt = o2(() => {
  let e2 = Y(), { data: t } = $r({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
...
var zs = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  let a = grid_default.useBreakpoint(), l = r ?? Ct2, u = t ?? Bt, y = typeof a.sm > "u" ? true : a.sm;
...
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react92.useState)(false), [a, l] = (0, import_react92.useState)(false), u = qr(), y = Z(), p = ot(), { warnWhen: f, setWarnWhen: d } = lt(), { Link: T } = te(), g = y === "legacy" ? T : p, m = ea(), b = G(), { menuItems: x, selectedKey: C, defaultOpenKeys: S2 } = vu({ meta: r }), P = grid_default.useBreakpoint(), { hasDashboard: F } = ne(), B = Y(), { mutate: v } = yr({ v3LegacyAuthProviderCompatible: !!(B != null && B.isLegacy) }), D = typeof P.lg > "u" ? false : !P.lg, c = e2 ?? m ?? kt2, k = o2((E, $) => E.map((L) => {
    let { icon: M, label: V, route: Z2, key: Q, name: O2, children: w, parentName: z, meta: _, options: ee } = L;
    if (w.length > 0) return import_react92.default.createElement(ac, { key: L.key, resource: O2, action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.SubMenu, { key: L.key, icon: M ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: V }, k(w, $)));
    let J = Q === $, te2 = !(S(_ == null ? void 0 : _.parent, ee == null ? void 0 : ee.parent, z) !== void 0 && w.length === 0);
    return import_react92.default.createElement(ac, { key: L.key, resource: O2, action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.Item, { key: L.key, icon: M ?? (te2 && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(g, { to: Z2 ?? "" }, V), !n2 && J && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), U = o2(() => {
    f ? window.confirm(b("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (d(false), v()) : v();
  }, "handleLogout"), H = u && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => U(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, b("buttons.logout", "Logout")), G2 = F ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(g, { to: "/" }, b("dashboard.title", "Dashboard")), !n2 && C === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, h = k(x, C), q = o2(() => t ? t({ dashboard: G2, items: h, logout: H, collapsed: n2 }) : import_react92.default.createElement(import_react92.default.Fragment, null, G2, h, H), "renderSider"), Y2 = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: C ? [C] : [], defaultOpenKeys: S2, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    l(false), P.lg || i(true);
  } }, q())), "renderMenu"), A = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: a, onClose: () => l(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react92.default.createElement(c, { collapsed: false })), Y2()))), import_react92.default.createElement(button_default, { style: xo, size: "large", onClick: () => l(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? A() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (E) => i(E), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react92.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(c, { collapsed: n2 })), Y2());
}, "ThemedSider");
var Dt = o2(() => {
  let { token: e2 } = theme_default.useToken(), t = Y(), { data: r } = $r({ v3LegacyAuthProviderCompatible: !!(t != null && t.isLegacy) });
...
var kt2 = o2(({ collapsed: e2, icon: t = kn, text: r = Ln, wrapperStyles: s }) => {
  let { token: n2 } = theme_default.useToken(), i = Z(), a = ot(), { Link: l } = te();
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var Z2;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: l, mobileSiderOpen: u, setMobileSiderOpen: y } = fo(), p = qr(), f = (Z2 = (0, import_react96.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Z2.direction, d = Z(), T = ot(), { warnWhen: g, setWarnWhen: m } = lt(), { Link: b } = te(), x = d === "legacy" ? b : T, C = ea(), S2 = G(), { menuItems: P, selectedKey: F, defaultOpenKeys: B } = vu({ meta: r }), v = grid_default.useBreakpoint(), { hasDashboard: D } = ne(), c = Y(), { mutate: k } = yr({ v3LegacyAuthProviderCompatible: !!(c != null && c.isLegacy) }), U = typeof v.lg > "u" ? false : !v.lg, H = e2 ?? C ?? ge2, G2 = o2((Q, O2) => Q.map((w) => {
    let { icon: z, label: _, route: ee, key: J, name: te2, children: ne2, parentName: j, meta: ae2, options: ce2 } = w;
    if (ne2.length > 0) return import_react96.default.createElement(ac, { key: w.key, resource: te2, action: "list", params: { resource: w } }, import_react96.default.createElement(menu_default.SubMenu, { key: w.key, icon: z ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: _ }, G2(ne2, O2)));
    let X = J === O2, oe = !(S(ae2 == null ? void 0 : ae2.parent, ce2 == null ? void 0 : ce2.parent, j) !== void 0 && ne2.length === 0), de = n2 && X ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(ac, { key: w.key, resource: te2, action: "list", params: { resource: w } }, import_react96.default.createElement(menu_default.Item, { key: w.key, icon: z ?? (oe && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: de }, import_react96.default.createElement(x, { to: ee ?? "", style: de }, _), !a && X && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), h = o2(() => {
    g ? window.confirm(S2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), k()) : k();
  }, "handleLogout"), q = p && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => h(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, S2("buttons.logout", "Logout")), Y2 = D ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(x, { to: "/" }, S2("dashboard.title", "Dashboard")), !a && F === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, A = G2(P, F), E = o2(() => t ? t({ dashboard: Y2, items: A, logout: q, collapsed: a }) : import_react96.default.createElement(import_react96.default.Fragment, null, Y2, A, q), "renderSider"), $ = o2(() => import_react96.default.createElement(menu_default, { selectedKeys: F ? [F] : [], defaultOpenKeys: B, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, E()), "renderMenu"), L = o2(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react96.default.createElement(H, { collapsed: false })), $()))), import_react96.default.createElement(button_default, { style: vo, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (U) return L();
  let M = { backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` };
  s && (M.position = "fixed", M.top = 0, M.height = "100vh", M.zIndex = 999);
  let V = o2(() => {
    let Q = { style: { color: i.colorPrimary } };
    return import_react96.default.createElement(a ? f === "rtl" ? LeftOutlined_default : RightOutlined_default : f === "rtl" ? RightOutlined_default : LeftOutlined_default, { ...Q });
  }, "renderClosingIcons");
  return import_react96.default.createElement(import_react96.default.Fragment, null, s && import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: M, collapsible: true, collapsed: a, onCollapse: (Q, O2) => {
    O2 === "clickTrigger" && l(Q);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react96.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, V()) }, import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react96.default.createElement(H, { collapsed: a })), $()));
}, "ThemedSiderV2");
var It = o2(({ isSticky: e2, sticky: t }) => {
  let { token: r } = theme_default.useToken(), s = Y(), { data: n2 } = $r({ v3LegacyAuthProviderCompatible: !!(s != null && s.isLegacy) });
...
var ge2 = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  let { title: { icon: n2, text: i } = {} } = Ct(), a = typeof t > "u" ? n2 : t, l = typeof r > "u" ? i : r, { token: u } = theme_default.useToken(), y = Z(), p = ot(), { Link: f } = te();
...
var Ut = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  let { hidden: u, disabled: y, label: p, title: f, LinkComponent: d, to: T } = Tv({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return u ? null : import_react99.default.createElement(d, { to: T, replace: false, onClick: (g) => {
    if (y) {
      g.preventDefault();
      return;
    }
...
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, label: p, title: f, hidden: d, disabled: T, LinkComponent: g } = yv({ resource: e2 ?? t, id: r, meta: i, accessControl: n2 });
  return d ? null : import_react100.default.createElement(g, { to: y, replace: false, onClick: (m) => {
    if (T) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: T, title: f, className: n.EditButton, ...u }, !s && (a ?? p)));
}, "EditButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: l, hideText: u = false, accessControl: y, metaData: p, meta: f, dataProviderName: d, confirmTitle: T, confirmOkText: g, confirmCancelText: m, invalidates: b, ...x }) => {
  let { title: C, label: S2, hidden: P, disabled: F, loading: B, confirmTitle: v, confirmOkLabel: D, cancelLabel: c, onConfirm: k } = Uu({ resource: e2 ?? t, id: r, dataProviderName: d, invalidates: b, meta: f, onSuccess: s, mutationMode: n2, errorNotification: l, successNotification: a, accessControl: y });
  return P ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: g ?? D, cancelText: m ?? c, okType: "danger", title: T ?? v, okButtonProps: { disabled: B }, onConfirm: k, disabled: typeof (x == null ? void 0 : x.disabled) < "u" ? x.disabled : F }, import_react101.default.createElement(button_default, { danger: true, loading: B, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: C, disabled: F, className: n.DeleteButton, ...x }, !u && (i ?? S2)));
}, "DeleteButton");
var _e = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: l, ...u }) => {
  let { onClick: y, label: p, loading: f } = Mu({ resource: e2 ?? t, id: r, dataProviderName: n2 });
...
var Ha = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, label: p, title: f, hidden: d, disabled: T, LinkComponent: g } = fv({ resource: e2 ?? t, id: r, accessControl: n2, meta: i });
  return d ? null : import_react103.default.createElement(g, { to: y, replace: false, onClick: (m) => {
    if (T) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: T, title: f, className: n.ShowButton, ...u }, !s && (a ?? p)));
}, "ShowButton");
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  let { to: u, label: y, title: p, hidden: f, disabled: d, LinkComponent: T } = xv({ resource: e2 ?? t, accessControl: s, meta: n2 });
  return f ? null : import_react104.default.createElement(T, { to: u, replace: false, onClick: (g) => {
    if (d) {
      g.preventDefault();
      return;
    }
...
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  let { to: y, LinkComponent: p, label: f, disabled: d, hidden: T, title: g } = gv({ id: r, resource: t ?? e2, accessControl: n2, meta: i });
  return T ? null : import_react107.default.createElement(p, { to: y, replace: false, onClick: (m) => {
    if (d) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: d, title: g, className: n.CloneButton, ...u }, !s && (a ?? f)));
}, "CloneButton");
...
var hi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: l, breadcrumb: u, headerButtonProps: y, headerButtons: p }) => {
  var F, B;
  let f = G(), { options: { breadcrumb: d } = {} } = ne(), T = Z(), g = at(), { resource: m, identifier: b } = O(n2), x = e2 ?? (((m == null ? void 0 : m.canCreate) ?? !!(m != null && m.create)) || s), C = typeof u > "u" ? d : u, S2 = x ? { size: "middle", resource: T === "legacy" ? m == null ? void 0 : m.route : b, ...s } : void 0, P = x ? import_react109.default.createElement(Ut, { ...S2 }) : null;
  return import_react109.default.createElement("div", { ...i ?? {} }, import_react109.default.createElement(Le, { ghost: false, title: t ?? f(`${b}.titles.list`, g(((F = m == null ? void 0 : m.meta) == null ? void 0 : F.label) ?? ((B = m == null ? void 0 : m.options) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? b, "plural")), extra: p ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof p == "function" ? p({ defaultButtons: P, createButtonProps: S2 }) : p) : P, breadcrumb: typeof C < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, C) ?? void 0 : import_react109.default.createElement(ve, null), ...l ?? {} }, import_react109.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: l, contentProps: u, headerButtonProps: y, headerButtons: p, footerButtonProps: f, footerButtons: d, goBack: T }) => {
  var k, U;
  let g = G(), { options: { breadcrumb: m } = {} } = ne(), b = Z(), x = co(), { goBack: C } = ce(), S2 = at(), { resource: P, action: F, identifier: B } = O(s), v = typeof i > "u" ? m : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, c = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...D }));
  return import_react110.default.createElement("div", { ...a ?? {} }, import_react110.default.createElement(Le, { ghost: false, backIcon: T, onBack: F !== "list" || typeof F < "u" ? b === "legacy" ? C : x : void 0, title: e2 ?? g(`${B}.titles.create`, `Create ${S2(((k = P == null ? void 0 : P.meta) == null ? void 0 : k.label) ?? ((U = P == null ? void 0 : P.options) == null ? void 0 : U.label) ?? (P == null ? void 0 : P.label) ?? B, "singular")}`), breadcrumb: typeof v < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, v) ?? void 0 : import_react110.default.createElement(ve, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: null }) : p : null), ...l ?? {} }, import_react110.default.createElement(spin_default, { spinning: n2 }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...f ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: c, saveButtonProps: D }) : d : c)], ...u ?? {} }, r))));
}, "Create");
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: l, isLoading: u = false, dataProviderName: y, breadcrumb: p, wrapperProps: f, headerProps: d, contentProps: T, headerButtonProps: g, headerButtons: m, footerButtonProps: b, footerButtons: x, goBack: C, autoSaveProps: S2 }) => {
  var ee, J, te2;
  let P = G(), { options: { breadcrumb: F } = {} } = ne(), { mutationMode: B } = ke(), v = r ?? B, D = Z(), c = co(), k = ge(), { goBack: U, list: H } = ce(), G2 = at(), { resource: h, action: q, id: Y2, identifier: A } = O(l), E = au({ resource: h, action: "list" }), $ = s ?? Y2, L = typeof p > "u" ? F : p, M = (h == null ? void 0 : h.list) && !s, V = a ?? ((((ee = h == null ? void 0 : h.meta) == null ? void 0 : ee.canDelete) ?? (h == null ? void 0 : h.canDelete)) || i), Z2 = M ? { ...u ? { disabled: true } : {}, resource: D === "legacy" ? h == null ? void 0 : h.route : A } : void 0, Q = { ...u ? { disabled: true } : {}, resource: D === "legacy" ? h == null ? void 0 : h.route : A, recordItemId: $, dataProviderName: y }, O2 = V ? { ...u ? { disabled: true } : {}, resource: D === "legacy" ? h == null ? void 0 : h.route : A, mutationMode: v, onSuccess: () => {
    D === "legacy" ? H((h == null ? void 0 : h.route) ?? (h == null ? void 0 : h.name) ?? "") : k({ to: E });
  }, recordItemId: $, dataProviderName: y, ...i } : void 0, w = { ...u ? { disabled: true } : {}, ...t }, z = import_react111.default.createElement(import_react111.default.Fragment, null, S2 && import_react111.default.createElement(Oo, { ...S2 }), M && import_react111.default.createElement(Ze, { ...Z2 }), import_react111.default.createElement(_e, { ...Q })), _ = import_react111.default.createElement(import_react111.default.Fragment, null, V && import_react111.default.createElement(Ye, { ...O2 }), import_react111.default.createElement(Xe, { ...w }));
  return import_react111.default.createElement("div", { ...f ?? {} }, import_react111.default.createElement(Le, { ghost: false, backIcon: C, onBack: q !== "list" && typeof q < "u" ? D === "legacy" ? U : c : void 0, title: e2 ?? P(`${A}.titles.edit`, `Edit ${G2(((J = h == null ? void 0 : h.meta) == null ? void 0 : J.label) ?? ((te2 = h == null ? void 0 : h.options) == null ? void 0 : te2.label) ?? (h == null ? void 0 : h.label) ?? A, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...g ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: z, listButtonProps: Z2, refreshButtonProps: Q }) : m : z), breadcrumb: typeof L < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, L) ?? void 0 : import_react111.default.createElement(ve, null), ...d ?? {} }, import_react111.default.createElement(spin_default, { spinning: u }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...b ?? {} }, x ? typeof x == "function" ? x({ defaultButtons: _, deleteButtonProps: O2, saveButtonProps: w }) : x : _)], ...T ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: l, breadcrumb: u, contentProps: y, headerProps: p, wrapperProps: f, headerButtons: d, footerButtons: T, footerButtonProps: g, headerButtonProps: m, goBack: b }) => {
  var Q, O2, w;
  let x = G(), { options: { breadcrumb: C } = {} } = ne(), S2 = Z(), P = co(), F = ge(), { goBack: B, list: v } = ce(), D = at(), { resource: c, action: k, id: U, identifier: H } = O(i), G2 = au({ resource: c, action: "list" }), h = a ?? U, q = typeof u > "u" ? C : u, Y2 = (c == null ? void 0 : c.list) && !a, A = r ?? ((Q = c == null ? void 0 : c.meta) == null ? void 0 : Q.canDelete) ?? (c == null ? void 0 : c.canDelete), E = t ?? (c == null ? void 0 : c.canEdit) ?? !!(c != null && c.edit), $ = Y2 ? { resource: S2 === "legacy" ? c == null ? void 0 : c.route : H } : void 0, L = E ? { ...s ? { disabled: true } : {}, type: "primary", resource: S2 === "legacy" ? c == null ? void 0 : c.route : H, recordItemId: h } : void 0, M = A ? { ...s ? { disabled: true } : {}, resource: S2 === "legacy" ? c == null ? void 0 : c.route : H, recordItemId: h, onSuccess: () => {
    S2 === "legacy" ? v((c == null ? void 0 : c.route) ?? (c == null ? void 0 : c.name) ?? "") : F({ to: G2 });
  }, dataProviderName: l } : void 0, V = { ...s ? { disabled: true } : {}, resource: S2 === "legacy" ? c == null ? void 0 : c.route : H, recordItemId: h, dataProviderName: l }, Z2 = import_react112.default.createElement(import_react112.default.Fragment, null, Y2 && import_react112.default.createElement(Ze, { ...$ }), E && import_react112.default.createElement(Ot, { ...L }), A && import_react112.default.createElement(Ye, { ...M }), import_react112.default.createElement(_e, { ...V }));
  return import_react112.default.createElement("div", { ...f ?? {} }, import_react112.default.createElement(Le, { ghost: false, backIcon: b, onBack: k !== "list" && typeof k < "u" ? S2 === "legacy" ? B : P : void 0, title: e2 ?? x(`${H}.titles.show`, `Show ${D(((O2 = c == null ? void 0 : c.meta) == null ? void 0 : O2.label) ?? ((w = c == null ? void 0 : c.options) == null ? void 0 : w.label) ?? (c == null ? void 0 : c.label) ?? H, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...m ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: Z2, deleteButtonProps: M, editButtonProps: L, listButtonProps: $, refreshButtonProps: V }) : d : Z2), breadcrumb: typeof q < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, q) ?? void 0 : import_react112.default.createElement(ve, null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: s }, import_react112.default.createElement(card_default, { bordered: false, actions: T ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...g }, typeof T == "function" ? T({ defaultButtons: null }) : T)] : void 0, ...y ?? {} }, n2))));
}, "Show");
...
var xp = o2(({ value: e2, locales: t, format: r = "L", ...s }) => {
  ...
  return import_react118.default.createElement(typography_default.Text, { ...s }, (0, import_dayjs5.default)(e2).locale(t || n2).format(r));
}, "DateField");
var Cp = o2(({ title: e2, src: t, ...r }) => import_react119.default.createElement(Gt, { value: t, title: e2, ...r }, e2 ?? t), "FileField");
var Gt = o2(({ children: e2, value: t, ...r }) => import_react120.default.createElement(typography_default.Link, { href: t, ...r }, e2 ?? t), "UrlField");
function Lp() {
...
var Up = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((d) => d, "mapValue"), selectedKeys: i, children: a } = e2, l = G(), u = o2(() => {
    s && s();
  }, "clearFilter"), y = o2(() => {
    let d;
    ...
    if (typeof d == "object") {
      ...
      let g = !d || !d.target || import_dayjs6.default.isDayjs(d) ? { target: { value: d } } : d, { target: m } = g, b = n2(m.value, "onChange");
      t(b);
      return;
    }
    let T = n2(d, "onChange");
...
var Yp = o2(() => {
  let [e2, t] = (0, import_react124.useState)(), r = G(), { push: s } = ce(), n2 = ge(), i = Z(), { resource: a, action: l } = O();
...
var Go2 = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var Ko = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var nl = o2(() => {
  let [e2] = form_default.useForm(), t = G(), r = Y(), { mutate: s, isLoading: n2 } = kt({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), i = import_react125.default.createElement(typography_default.Title, { level: 3, style: Go2 }, t("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: jo }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Wo }, import_react125.default.createElement("div", { style: Ko }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    s(a);
...
var He = { root: { height: "100vh", backgroundImage: "url('https://refine.ams3.cdn.digitaloceanspaces.com/login-background/background.png')", backgroundSize: "cover", backgroundColor: "#331049" }, title: { color: "white", fontWeight: 800, fontSize: "64px", marginBottom: "8px" }, p1: { color: "white", marginBottom: 0, fontSize: "20px", fontWeight: "bold" }, p2: { color: "white", fontSize: "20px" }, code: { backgroundColor: "white", color: "#331049" } };
var cl = o2(() => se.createElement(row_default, { align: "middle", justify: "center", style: He.root }, se.createElement(col_default, { style: { textAlign: "center" } }, se.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), se.createElement(typography_default.Title, { style: He.title }, "Welcome on board"), se.createElement("p", { style: He.p1 }, "Your configuration is completed."), se.createElement("p", { style: He.p2 }, "Now you can get started by adding your resources to the", " ", se.createElement("code", { style: He.code }, "resources"), " property of", " ", se.createElement("code", { style: He.code }, "<Refine>")), se.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, se.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(ReadOutlined_default, null) }, "Documentation")), se.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(FolderOutlined_default, null) }, "Examples")), se.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
var Tl = o2(() => import_react126.default.createElement(Gu, null), "WelcomePage");
var ke2 = {};
var De = { maxWidth: "400px", margin: "auto", padding: "32px", boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.02), 0px 1px 6px -1px rgba(0, 0, 0, 0.02), 0px 1px 2px rgba(0, 0, 0, 0.03)" };
var we = { borderBottom: 0, padding: 0 };
var Ee = { padding: 0, marginTop: "32px" };
var Re = { textAlign: "center", marginBottom: 0, fontSize: "24px", lineHeight: "32px", fontWeight: 700, overflowWrap: "break-word", hyphens: "manual", textOverflow: "unset", whiteSpace: "pre-wrap" };
var $t = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: l, title: u, hideForm: y }) => {
  let { token: p } = theme_default.useToken(), [f] = form_default.useForm(), d = G(), T = Z(), g = ot(), { Link: m } = te(), b = T === "legacy" ? m : g, x = Y(), { mutate: C, isLoading: S2 } = kt({ v3LegacyAuthProviderCompatible: !!(x != null && x.isLegacy) }), P = u === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, u ?? import_react128.default.createElement(ge2, { collapsed: false })), F = import_react128.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Re } }, d("pages.login.title", "Sign in to your account")), B = o2(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((D) => import_react128.default.createElement(button_default, { key: D.name, type: "default", block: true, icon: D.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ providerName: D.name }) }, D.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(typography_default.Text, { style: { color: p.colorTextLabel } }, d("pages.login.divider", "or")))) : null, "renderProviders"), v = import_react128.default.createElement(card_default, { title: F, headStyle: we, bodyStyle: Ee, style: { ...De, backgroundColor: p.colorBgElevated }, ...n2 ?? {} }, B(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: f, onFinish: (D) => C(D), requiredMark: false, initialValues: { remember: false }, ...l }, import_react128.default.createElement(form_default.Item, { name: "email", label: d("pages.login.fields.email", "Email"), rules: [{ required: true, message: d("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: d("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: d("pages.login.fields.password", "Password"), rules: [{ required: true, message: d("pages.login.errors.requiredPassword", "Password is required") }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, d("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react128.default.createElement(b, { style: { color: p.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, d("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: S2, block: true }, d("pages.login.signin", "Sign in")))), t ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(b, { to: "/register", style: { fontWeight: "bold", color: p.colorPrimaryTextHover } }, d("pages.login.signup", "Sign up")))));
  return import_react128.default.createElement(layout_default, { style: ke2, ...i ?? {} }, import_react128.default.createElement(row_default, { justify: "center", align: y ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: y ? "15dvh" : "16px" } }, import_react128.default.createElement(col_default, { xs: 22 }, a ? a(v, P) : import_react128.default.createElement(import_react128.default.Fragment, null, P, v))));
}, "LoginPage");
var Yt = o2(({ providers: e2, loginLink: t, wrapperProps: r, contentProps: s, renderContent: n2, formProps: i, title: a, hideForm: l }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), p = G(), f = Z(), d = ot(), { Link: T } = te(), g = f === "legacy" ? T : d, m = Y(), { mutate: b, isLoading: x } = jr({ v3LegacyAuthProviderCompatible: !!(m != null && m.isLegacy) }), C = a === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react129.default.createElement(ge2, { collapsed: false })), S2 = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Re } }, p("pages.register.title", "Sign up for your account")), P = o2(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((B) => import_react129.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => b({ providerName: B.name }) }, B.label)), !l && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, p("pages.login.divider", "or")))) : null, "renderProviders"), F = import_react129.default.createElement(card_default, { title: S2, headStyle: we, bodyStyle: Ee, style: { ...De, backgroundColor: u.colorBgElevated }, ...s ?? {} }, P(), !l && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (B) => b(B), requiredMark: false, ...i }, import_react129.default.createElement(form_default.Item, { name: "email", label: p("pages.register.email", "Email"), rules: [{ required: true, message: p("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: p("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: p("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: p("pages.register.fields.password", "Password"), rules: [{ required: true, message: p("pages.register.errors.requiredPassword", "Password is required") }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(g, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: x, block: true }, p("pages.register.buttons.submit", "Sign up")))), l && t !== false && import_react129.default.createElement("div", { style: { marginTop: l ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(g, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))));
  return import_react129.default.createElement(layout_default, { style: ke2, ...r ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: l ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: l ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, n2 ? n2(F, C) : import_react129.default.createElement(import_react129.default.Fragment, null, C, F))));
}, "RegisterPage");
var _t = o2(({ loginLink: e2, wrapperProps: t, contentProps: r, renderContent: s, formProps: n2, title: i }) => {
  let { token: a } = theme_default.useToken(), [l] = form_default.useForm(), u = G(), y = Z(), p = ot(), { Link: f } = te(), d = y === "legacy" ? f : p, { mutate: T, isLoading: g } = Zr(), m = i === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react130.default.createElement(ge2, { collapsed: false })), b = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Re } }, u("pages.forgotPassword.title", "Forgot your password?")), x = import_react130.default.createElement(card_default, { title: b, headStyle: we, bodyStyle: Ee, style: { ...De, backgroundColor: a.colorBgElevated }, ...r ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: l, onFinish: (C) => T(C), requiredMark: false, ...n2 }, import_react130.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(d, { style: { fontWeight: "bold", color: a.colorPrimaryTextHover }, to: "/login" }, u("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: g, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ke2, ...t ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, s ? s(x, m) : import_react130.default.createElement(import_react130.default.Fragment, null, m, x))));
}, "ForgotPasswordPage");
var Zt = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2 }) => {
  let { token: i } = theme_default.useToken(), [a] = form_default.useForm(), l = G(), u = Y(), { mutate: y, isLoading: p } = Jr({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), f = n2 === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react131.default.createElement(ge2, { collapsed: false })), d = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...Re } }, l("pages.updatePassword.title", "Set New Password")), T = import_react131.default.createElement(card_default, { title: d, headStyle: we, bodyStyle: Ee, style: { ...De, backgroundColor: i.colorBgElevated }, ...t ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: a, onFinish: (g) => y(g), requiredMark: false, ...s }, import_react131.default.createElement(form_default.Item, { name: "password", label: l("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: l("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: l("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: l("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: g }) => ({ validator(m, b) {
    return !b || g("password") === b ? Promise.resolve() : Promise.reject(new Error(l("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  ...
  return import_react131.default.createElement(layout_default, { style: ke2, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, r ? r(T, f) : import_react131.default.createElement(import_react131.default.Fragment, null, f, T))));
}, "UpdatePasswordPage");
var dd = o2((e2) => {
  let { type: t } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, o2(() => {
    switch (t) {
      ...
      default:
        return import_react127.default.createElement($t, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var ve = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s }) => {
  let n2 = Z(), { breadcrumbs: i } = QC({ meta: s }), a = ot(), { Link: l } = te(), { hasDashboard: u } = ne(), { resources: y } = O(), p = Go("/", y), f = n2 === "legacy" ? l : a;
  if (i.length === 1) return null;
  let d = i.map(({ label: g, icon: m, href: b }) => ({ key: `breadcrumb-item-${g}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && m, b ? import_react132.default.createElement(f, { to: b }, g) : import_react132.default.createElement("span", null, g)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: o2(() => {
    var g, m;
    return t && (u || p.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(f, { to: "/" }, ((m = (g = p == null ? void 0 : p.resource) == null ? void 0 : g.meta) == null ? void 0 : m.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...d] : d;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var Le = o2(({ children: e2, ...t }) => {
  var l;
...
var Oo = o2(({ status: e2, elements: { success: t = import_react134.default.createElement(ut, { translationKey: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: r = import_react134.default.createElement(ut, { translationKey: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: s = import_react134.default.createElement(ut, { translationKey: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react134.default.createElement(ut, { translationKey: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(dc, { status: e2, elements: { success: t, error: r, loading: s, idle: n2 } }), "AutoSaveIndicator");
var ut = o2(({ translationKey: e2, defaultMessage: t, icon: r }) => {
  let s = G(), { token: n2 } = theme_default.useToken();
...
export {
  ...
  yt as mapAntdSorterToCrudSorting,
  ac2 as notificationProvider,
